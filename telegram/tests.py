...
class TelegramUtilsTest(TestCase):
    ...
    async def test_parse_messages(self, mock_client):
        ...
        messages = await parse_messages(mock_client, "@testchannel")
...
class TelegramViewsTest(APITestCase):
    ...
    async def test_telegram_add_channel(self, mock_client):
    ...
    async def test_get_from_tg_success(self, mock_download):
